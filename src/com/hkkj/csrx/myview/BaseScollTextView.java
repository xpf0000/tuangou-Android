...
public abstract class BaseScollTextView<T> extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        if (typedArray.hasValue(R.styleable.BaseScollTextView_textSize)) {
            ...
            textSize=typedArray.getFloat(R.styleable.BaseScollTextView_textSize,textSize);
            System.out.println("R.styleable.BaseScollTextView_textSize:"+textSize);
//            textSize=(textSize * density + 0.5f);
//            textSize = typedArray.getDimensionPixelOffset(, (int) (density * 7));
        }
        textColor = typedArray.getColor(R.styleable.BaseScollTextView_textColor, textColor);
        System.out.println("textSize:"+textSize+"R.styleable.BaseScollTextView_textSize:"+R.styleable.BaseScollTextView_textSize);
    ...
    public abstract SpannableStringBuilder getItemText(List<T> data, int postion);
