 ...
 */
public class Mianfei_jieshu extends FragmentActivity implements View.OnClickListener
{
    private String ID;
    ...
    private TextView title,renshu,shuliang,shiyongjia,zhenshijia,shijian;
    private LinearLayout pinglu,pinglu1,pinglu2,pinglu3;
    RelativeLayout kanquanbu;
   ...
   private my_viewpage viewPager;
    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            {
                case 1:
                    Toast.makeText(Mianfei_jieshu.this,"网络超时",Toast.LENGTH_SHORT).show();
                    break;
                case 2:
                    try {
                        jiexi();
                    ...
                    break;
                case 3:
                    Toast.makeText(Mianfei_jieshu.this,"请求失败",Toast.LENGTH_SHORT).show();
                    break;
                case 4:
                    ...
                    webView.loadDataWithBaseURL(null, hashMap.get("Content"), "text/html",
                            "utf-8", null);
                    shijian.setText((Integer.parseInt(aa[0])+1 )+"天"+(Integer.parseInt(aa[1])+1 )+"小时");
                ...
                for(int i=0;i<jsonArray.length();i++)
                {
                    ...
                    pinglu.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                        {
                            ...
                            intent.setClass(Mianfei_jieshu.this,Shiyong_pinglun.class);
                            intent.putExtra("shuju", jsonObject1.toString());
                            Mianfei_jieshu.this.startActivity(intent);
                        }
                    });
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.mianfeishiyong_jieshu);
        settextview();
        init();
    }
    ...
    private void init()
    {
       viewPager=(my_viewpage)findViewById(R.id.viewPager);
        ...
        ImageLoader.init(ImageLoaderConfiguration.createDefault(Mianfei_jieshu.this));
        ...
        PreferencesUtils.putString(Mianfei_jieshu.this,"freeId",ID);
        kanquanbu.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent=new Intent();
                intent.setClass(Mianfei_jieshu.this,ShiyongQuanbupinglun.class);
        ...
        shijian=(TextView)findViewById(R.id.huodongshijian);
    ...
    private void lianwnag(final String url, final int type)
    {
        ...
        new Thread()
        {
            ...
            public void run() {
                ...
                if(type==1){
             str=httpRequest.doGet(url,Mianfei_jieshu.this);
                    if(str.equals("网络超时"))
                    {
                ...
                {
                    str1=httpRequest.doGet(url,Mianfei_jieshu.this);
                    if(str1.equals("网络超时"))
                    {
                        handler.sendEmptyMessage(1);
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.fenxiang:
                ...
                int cityID = PreferencesUtils.getInt(Mianfei_jieshu.this, "cityID");
                String citypl = PreferencesUtils.getString(Mianfei_jieshu.this, "cityNamepl");
                String sharePath = "http://m.rexian.cn/try/detail/"+cityID+"/"+ID;
                OnekeyShare oks = new OnekeyShare();
                oks.disableSSOWhenAuthorize();// 分享前要先授权
//                oks.setNotification(R.drawable.ic_launcher,
//                        getString(R.string.app_name));
                String cityname=PreferencesUtils.getString(Mianfei_jieshu.this, "cityName");
            ...
            case R.id.jindian:
                // 把商铺ID写入xml文件中
                PreferencesUtils.putString(Mianfei_jieshu.this, "storeID",hashMap.get("StoreID"));
            if(hashMap.get("Isvip").equals("2"))
            {
                Intent intent = new Intent(Mianfei_jieshu.this,
                        shangjiavip.class);
                ...
                intent.putExtra("area",String.valueOf(PreferencesUtils.getInt(Mianfei_jieshu.this, "cityID")));
