 ...
 */
public class ShangjiasActivicty extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener
{
...
//		GetMyData.setLocationOption(mLocClient);
        ...
        areaid = PreferencesUtils.getInt(ShangjiasActivicty.this, "cityID");
        classurl = Constant.url+"industrylist?areaId="
                + areaid;
        areaurl =  Constant.url+"GetTown?areaId="
                + areaid;
        bigClass=getIntent().getStringExtra("id");
        ...
        if (Constant.KEY != null) {
            ...
            url = Constant.url+"storelistnearby?areaId="
                    ...
                    + "0" + "&smallClassId=" + smallClass + "&bigAreaId="
                    + areatownid + "&smallAreaId=" + quanid +"&key="+key+"&order="
...
//                    page--;
//                }
//                Toast.makeText(ShangjiasActivicty.this, "网络似乎有问题了", Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
...
//            @Override
//            public void onFailure(int i, Header[] headers, String s, Throwable throwable) {
//                Toast.makeText(ShangjiasActivicty.this, "网路请求超时", Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
//            public void onSuccess(int i, Header[] headers, String s) {
...
//        });
    ...
    {
        privileadpater=new MerchantListAdapter(ShangjiasActivicty.this,arrayList);
    ...
    {
        String[] orderStr = new String[]{"默认排序", "人气排序", "诚信指数","入驻时间"};
    ...
    public void onClick(View v)
    {
        switch (v.getId()) {
            ...
            case R.id.search:
                ...
                intent.setClass(ShangjiasActivicty.this, HotSearch.class);
                ShangjiasActivicty.this.startActivity(intent);
                break;
            case R.id.logn_img:
                finish();
                break;
...
//        });
    ...
    private void setclasspop() {
        myClassPop.showclasspop(classList, classmoreList, ShangjiasActivicty.this, layout);
    ...
    private void setorderpop() {
        myoneClasspop.showclasspop(orderList, ShangjiasActivicty.this, layout);
    ...
    private void setqupop() {
        myClassPop.showclasspop(areaList, areaclassList, ShangjiasActivicty.this, layout);
        myClassPop.setMyPopwindowswListener(new MyClassPop.MyPopwindowsListener() {
            @Override
            public void onRefresh(int position, ClassAdapter smadapter) {
                if (position == 0) {
    ...
    private void setArrayList(String s) {
        ...
        if (jsonObject.getIntValue("status") == 0) {
            ...
            Toast.makeText(ShangjiasActivicty.this, "暂无更多", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        // 把商铺ID写入xml文件中
        PreferencesUtils.putString(ShangjiasActivicty.this, "storeID", arrayList
                .get(arg2).get("id").toString());
        if (arrayList.get(arg2).get("isvip").equals("2")){
            Intent intent = new Intent(ShangjiasActivicty.this,
                    shangjiavip.class);
            try{
