...
import com.X.tcbj.activity.SubmitOrder;
...
public class AttentionFragment extends Fragment {
    ...
    private void intview() {
        ...
        goshop = (Button) view.findViewById(R.id.goshop);
        kong = (LinearLayout) view.findViewById(R.id.kong);
        moeny = (LinearLayout) view.findViewById(R.id.moeny);
        getorder = (TextView) view.findViewById(R.id.getorder);
        allmoney = (TextView) view.findViewById(R.id.allmoney);
        all = (CheckBox) view.findViewById(R.id.all);
        shopcarlist = (ListView) view.findViewById(R.id.shopcarlist);
        try {
            setArray();
            if (IfCheck()) {
                all.setChecked(true);
        ...
        goshop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(getActivity(), Mall.class);
            ...
            public void onClick(View v) {
                ...
                if (Logn == 0) {
                    ...
                    if (orderProductarray.size() == 0) {
                        Toast.makeText(getActivity(), "未选择任何商品", Toast.LENGTH_SHORT).show();
                    } else {
    ...
    private void setArray() {
        String json = PreferencesUtils.getString(getActivity(), "shopcar");
        if (json == null) {
            handler.sendEmptyMessage(1);
        } else {
    ...
    private void setShopcarlist() {
        Constant.all = false;
        shopcarAdapter = new ShopcarAdapter(array, getActivity(), handler);
    ...
    private void getLike() {
        new Thread() {
            ...
            public void run() {
                ...
                likestr = httpRequest.doGet(url, getActivity());
...
//                shopcarAdapter.notifyDataSetChanged();
    ...
    public void updatecar(int ischeck) {
        ...
        PreferencesUtils.putString(getActivity(), "shopcar", jsonObject.toString());
    }
...
//            }
    ...
    private void setLiske() {
        ...
        adapter = new MyRecyclerAdapter(getActivity(), likearray);
