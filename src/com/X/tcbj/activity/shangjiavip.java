...
import com.X.tcbj.adapter.ShopPrivilegeBaseAdapter;
import com.X.tcbj.adapter.VipPhotoAdapter;
import com.X.tcbj.adapter.viplunboAdapter;
import com.X.tcbj.adapter.vippinglunAdapter;
import com.X.tcbj.adapter.vipremaiAdapter;
 ...
 */
public class shangjiavip extends Activity implements View.OnClickListener
{
    ...
    private Handler handler=new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            switch (msg.what)
            {
                ...
                case 3:
                    if (youhui.size()==0){
                        listView.removeHeaderView(tou2);
                    }
...
//                        nian.setLayoutParams(params3);
                    ...
                    break;
                case 4:
                    Toast.makeText(shangjiavip.this,"请求失败",Toast.LENGTH_SHORT).show();
                    break;
                case 5:
                ...
                case 6:
                    if (object == null) {
                        Toast.makeText(shangjiavip.this,
                        ...
                        if (statusMsg == 0) {
                            ...
                            Toast.makeText(shangjiavip.this, "收藏成功",
                ...
                case 9:
                    ...
                    if (object1== null) {
                        ...
                        if (statusMsg == 0) {
                            ...
                            xihuan.setCompoundDrawables(null, topDrawable, null, null);
                            xihuan.setTextColor(Color.RED);
                            Toast.makeText(shangjiavip.this, jsonObject.getString("statusMsg"),
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(shangjiavip.this,
                                    jsonObject.getString("statusMsg"), Toast.LENGTH_SHORT).show();
    ...
    private void dian()
    {
        ...
        for (int i = 0; i < lunbo.size(); i++) {
            imgView = new ImageView(shangjiavip.this);
...
//            params_linear.gravity = Gravity.CENTER;
    ...
    {
        userID = PreferencesUtils.getString(shangjiavip.this, "userid");
        logn = PreferencesUtils.getInt(shangjiavip.this, "logn");
        Intent intent=new Intent();
        switch (v.getId())
        {

            case R.id.dao1:
                intent = new Intent(shangjiavip.this,
            ...
            case R.id.dao6:
                Constant.SHOP_ID = id;// 记录商家id
                PreferencesUtils.putString(shangjiavip.this, "storeID",id);
                intent.putExtra("id",id);
                intent = new Intent(shangjiavip.this,
            ...
            case R.id.fenxiang:
                ...
                int cityID = PreferencesUtils.getInt(shangjiavip.this, "cityID");
                String sharePath = "http://m.rexian.cn/Store/getStoreInfoVIP?msg="
...
//                        getString(R.string.app_name));
                ...
                oks.setTitle(Constant.SHOP_NAME + "  " + PreferencesUtils.getString(shangjiavip.this, "cityName") + "城市热线");
            ...
            case R.id.search:
                ...
                intent1.setClass(shangjiavip.this,Shousuo.class);
                shangjiavip.this.startActivity(intent1);
                break;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Intent intent = new Intent(shangjiavip.this,HKService.class);
        shangjiavip.this.startService(intent);
        myBroadcastReciver = new MyBroadcastReciver();
        IntentFilter filter = new IntentFilter(HKService.action);
        shangjiavip.this.registerReceiver(myBroadcastReciver, filter);
        id = PreferencesUtils.getString(shangjiavip.this, "storeID");
        Constant.SHOP_ID = id;// 记录商家id
    ...
    private void lianwang1()
    {
        new Thread()
        {
            ...
            public void run()
            {
                ...
                shistr=httpRequest.doGet(shiurl,shangjiavip.this);
    ...
    private void lianwang(final int type)
    {
        new Thread()
        {
            ...
            public void run()
            {
                ...
                if(type==1){
                    HttpRequest httpRequest=new HttpRequest();
                    jieguo=httpRequest.doGet(url,shangjiavip.this);
                    pinglun=httpRequest.doGet(pingurl,shangjiavip.this);
    ...
    private void intview()
    {
        ...
        inflater = LayoutInflater.from(shangjiavip.this);
//        shuju=new String[]{"首页","商家介绍","商家相册","新闻资讯","热卖产品","活动优惠","网友点评","在线预订"};
        search=(ImageView)findViewById(R.id.search) ;
        layout=(RelativeLayout)findViewById(R.id.layouts);
        ...
        ditu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if (latitude!=0.0){
                    ...
                    intent.setClass(shangjiavip.this, BaiduMaps.class);
                    shangjiavip.this.startActivity(intent);
                }else if (getIntent().getDoubleExtra("map_Lat", 0.0) == 0.0 && getIntent().getDoubleExtra("map_Lon", 0.0) == 0.0) {
                    Toast.makeText(shangjiavip.this, "该商家未在地图上标注", Toast.LENGTH_SHORT).show();
                }else {
                    longitude = getIntent().getDoubleExtra("longitude", 0.0);
                    latitude = getIntent().getDoubleExtra("latitude", 0.0);
                    Intent intent=new Intent();
        ...
        adapter=new ShopPrivilegeBaseAdapter(shangjiavip.this,youhui);
...
//        }
        shopComentAdapter = new vippinglunAdapter(comentarray, shangjiavip.this);
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                intent.setClass(shangjiavip.this, Privileinfo.class);
                startActivity(intent);
        ...
        myGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                intent.setClass(shangjiavip.this, MallInfo.class);
                shangjiavip.this.startActivity(intent);}
                else
                {
                    Intent intent=new Intent();
                    intent.setClass(shangjiavip.this,ShopPhotoLook.class);
    ...
    private void getremaiadapter(int type)
    {
        if(type==1)
        {
        adapter1=new vipremaiAdapter(remai,shangjiavip.this);
        myGridView.setAdapter(adapter1);}
        else
        {
            vipPhotoAdapter = new VipPhotoAdapter(StorePhotoarray,shangjiavip.this);
