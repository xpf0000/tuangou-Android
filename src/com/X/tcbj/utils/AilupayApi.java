...
/**
 * Created by admins on 2015/11/10.
 */
public class AilupayApi {
    ...
    public void getPay(final Context context, String content) {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case SDK_PAY_FLAG: {
                        ...
                        {
                            XActivityindicator.showToast("支付结果确认中");
                        }
                        else  {

                            //XActivityindicator.showToast("支付失败");
...
//        String orderInfo = getOrderInfo(content);
//        String sign = sign(orderInfo,signs);
//        String sign=signs;
//        try {
//            // 仅需对sign 做URL编码
//
...
//    }
     ...
     */
    public String sign(String content,String signs) {
        return SignUtils.sign(content, signs);
    }
