        ...
        if (list.size() >= 0) {
            ...
            try {
                ...
                if (list.get(arg0).get("Map_Longitude").equals("")
                        || Double.parseDouble( list.get(arg0).get("longitude")) == 0.0) {
                    ...
                    double longitude = Double.parseDouble(list.get(arg0).get("longitude"));
                    double latitude = Double.parseDouble(list.get(arg0).get("latitude")) ;
