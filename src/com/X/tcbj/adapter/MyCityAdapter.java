...
public class MyCityAdapter extends BaseAdapter{
    ...
    private List<Area.Province.Citys> citysList;
    public MyCityAdapter(Context ctx,List<Area.Province.Citys> citysList){
        this.ctx=ctx;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        vh.tv.setText(citysList.get(i).getName());
        return view;
    }
