 ...
 */
public class xuanzechengshiAdapter extends BaseAdapter
{
    private ArrayList<HashMap<String, String>> quyu;
    private Context context;
    public xuanzechengshiAdapter(ArrayList<HashMap<String,String>>quyu,Context context)
    {
        this.quyu=quyu;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            convertView= LayoutInflater.from(context).inflate(R.layout.xuanzechengshi_item,null);
            hold=new Viewhoid();
